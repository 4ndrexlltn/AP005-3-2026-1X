...
def main():
    ...
    try:
        ...
        print(f"Conexión establecida con {PUERTO} a {BAUDIOS} baudios.")
        ...
        while True:
            ...
            if len(partes) != 3:
                print("[ADVERTENCIA] Línea con formato inesperado. Se omite.")
                continue
            ...
            try:
                ...
                print(f"[ADVERTENCIA] No se pudo convertir la línea: {error}")
                continue
